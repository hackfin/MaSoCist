...
-- Module  Version: 5.5
--/usr/local/diamond/3.1_x64/ispfpga/bin/lin64/scuba -w -n machxo2_pll -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 22.17 -fclkop 66.51 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock 

-- Tue Oct 22 00:26:11 2013
...
entity machxo2_pll is
    generic (
		CLKOP_CPHASE : natural := 12;
		PLL_MUL : natural := 2;
		PLL_DIV : natural := 3
	);
    port (
 ...
 attribute dont_touch of machxo2_pll : entity is true;
end machxo2_pll;

architecture Structure of machxo2_pll is
...
--    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "38.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  CLKOP_CPHASE, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  12, CLKFB_DIV=> PLL_MUL, CLKI_DIV=>  PLL_DIV, 
        FEEDBK_PATH=> "CLKOP")
...
library MACHXO2;
configuration Structure_CON of machxo2_pll is
    for Structure
