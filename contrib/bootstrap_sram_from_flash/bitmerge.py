...
padding = (LOGICAL_PAGE_SIZE - length % LOGICAL_PAGE_SIZE )
...
print "Merged user data begins at FLASH address 0x%06X" % (length+padding)

#write recalculated section length
data = struct.pack(">L", length + padding + bsize)
args.ofile.write(data)
