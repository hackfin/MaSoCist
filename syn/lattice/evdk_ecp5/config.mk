...
VERILOG_IP_BSP = pll_mac.v
VERILOG_BB_WRAPPERS += usrmclk_wrapper.v jtag_wrapper.v bram_2psync.v
...
WRAPPER_DIR = $(FPGA_VENDOR)/common
IPCORES_DIR = $(FPGA_VENDOR)/$(PLATFORM)/ipcores

VERILOG_BB_WRAPPERS-y = $(VERILOG_BB_WRAPPERS:%=$(WRAPPER_DIR)/%)
VERILOG_BB_WRAPPERS-y += $(VERILOG_IP_BSP:%=$(IPCORES_DIR)/%)
